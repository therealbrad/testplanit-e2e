...
describe('Contact Form', () => {
  ...
  it('[19] submits successfully and shows success message', async () => {
  ...
  it('[20] shows error when submitted with missing required field', async () => {
  ...
  it('[21] email field validates format before submission', async () => {
  ...
  it('[22] character limit enforced on the message field', async () => {
